...
def run_compare():
    ...
    prompt = "I want to buy 2 iPhones using code 'WINNER' and ship to Hanoi. Weight is 1kg. What is the total price after discount and shipping?"
    ...
    print("\n" + "="*80)
    print("🕵️‍♂️ REACT AGENT (With Ecommerce Tools)")
    print("="*80)
