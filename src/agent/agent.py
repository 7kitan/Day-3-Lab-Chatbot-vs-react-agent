...
from pydantic_core.core_schema import arguments_v3_parameter
    ...
    def run(self, user_input: str) -> str:
        ...
        while steps < self.max_steps:
            ...
            result = self.llm.generate(
                prompt=current_prompt, system_prompt=self.get_system_prompt()
            )
            ...
            if action_match:
                ...
                print(f"executing tool {tool_name} with arguments {args_str}")
